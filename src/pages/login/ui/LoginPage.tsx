  ...
  return (
    <SplashBackground>
      <div className={styles["login-box"]}>
        ...
        <Link
          to="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=7afd832d40c601c8d991c2096ac2b039&redirect_uri=http://localhost:8080/login/oauth/kakao"
